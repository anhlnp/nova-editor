// Instance tree → React element mapper.
//
// Ported verbatim from:
//   reference/webstudio/apps/builder/app/canvas/elements.tsx
// No functional changes — pure type/logic; no Remix/builder-specific imports.
