...
export const TEMPLATE_HERO: Template = {
  ...
  styles: [
    sd(s1.sec, "backgroundColor", rgb(255, 255, 255)),
    ...
    sd(s1.bs, "border",          { type: "keyword", value: "1px solid rgba(15, 23, 42, 0.15)" }),
  ],
};
...
export const TEMPLATE_FEATURES: Template = {
  ...
  styles: [
    sd(s2.sec, "backgroundColor",  rgb(248, 250, 252)),
    ...
    sd(s2.card, "backgroundColor", rgb(255, 255, 255)),
    ...
    sd(s2.card, "border",          { type: "keyword", value: "1px solid rgba(15, 23, 42, 0.08)" }),
    sd(s2.icon, "fontSize",        unit(32, "px")),
    sd(s2.cTitle, "fontSize",      unit(18, "px")),
    sd(s2.cTitle, "fontWeight",    kw("600")),
    sd(s2.cTitle, "color",         rgb(15, 23, 42)),
    sd(s2.cBody, "fontSize",       unit(14, "px")),
    sd(s2.cBody, "color",          rgb(71, 85, 105)),
...
export const TEMPLATE_SPLIT: Template = {
  ...
  styles: [
    sd(s3.sec, "backgroundColor",  rgb(255, 255, 255)),
    ...
    sd(s3.img, "backgroundColor",  rgb(241, 245, 249)),
    sd(s3.img, "borderRadius",     unit(16, "px")),
    sd(s3.img, "height",           unit(320, "px")),
    sd(s3.img, "border",           { type: "keyword", value: "1px solid rgba(15, 23, 42, 0.08)" }),
  ],
};
