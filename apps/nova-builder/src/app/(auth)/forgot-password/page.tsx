        ...
        <div style={{ width: "100%", maxWidth: 420, background: "#ffffff", border: "1.5px solid #e2e8f0", borderRadius: 20, padding: "40px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
          {sent ? (
            <div style={{ textAlign: "center" }}>
              ...
              <h1 style={{ margin: "0 0 8px", fontSize: 22, fontWeight: 800, color: "#0f172a" }}>{t.auth.forgotSentTitle}</h1>
              <p style={{ margin: "0 0 24px", fontSize: 15, color: "#64748b", lineHeight: 1.6 }}>{t.auth.forgotSentBody}</p>
              <Link href="/login" style={{ color: "#6d28d9", fontWeight: 600, textDecoration: "none", fontSize: 15 }}>{t.auth.backToLogin}</Link>
            </div>
          ) : (
            <>
              <h1 style={{ margin: "0 0 8px", fontSize: 24, fontWeight: 800, color: "#0f172a", textAlign: "center" }}>{t.auth.forgotTitle}</h1>
              <p style={{ margin: "0 0 28px", fontSize: 15, color: "#64748b", textAlign: "center", lineHeight: 1.6 }}>{t.auth.forgotSubtitle}</p>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: busy || !email ? "#c4b5fd" : "#6d28d9",
